...
export const CategoriesSection: React.FC = () => {
  return (
    <section
      className="relative py-10 sm:py-12 bg-white text-zinc-950 border-b border-border select-none overflow-hidden"
    >
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 sm:mb-10">
          <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-pill bg-zinc-100 border border-border text-xs font-bold uppercase tracking-widest text-amber-500 shadow-sm">
            <Sparkles size={13} className="text-amber-500" />
            Curated Collections
          </span>
          <h2 className="font-display font-extrabold text-3xl sm:text-5xl uppercase tracking-tight text-zinc-950 mt-2">
